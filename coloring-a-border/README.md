<h2>1034. Coloring A Border</h2><h3>Medium</h3><hr><div><p>Given a 2-dimensional&nbsp;<code>grid</code> of integers, each value in the grid represents the color of the grid square at that location.</p>
